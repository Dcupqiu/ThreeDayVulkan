...
namespace VulkanManager
{
    ...
    void VulkanUtil::createGlobalImage(RHI*               rhi,
                                       ...
                                       VULKAN_PIXEL_FORMAT texture_image_format,
                                       uint32_t           miplevels)
    {
